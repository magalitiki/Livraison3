...
NB: Pour l'instant, seuls:
- l'enregistrement d'un article dans la base de données, 
- l'affichage des détails d'un article enregistré
- la gestion d'exceptions sur le format de la reference d'un article
- la recherche d'un article
- l'enregistrement d'un fournisseur dans la base de données
- l'affichage des détails d'un fournisseur enregistré
- et la recherche d'un fournisseur ont été impléméntés.
